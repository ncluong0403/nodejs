export const USERS_MESSAGES = {
  ...
  MISSING_BEARER_BEFORE_ACCESS_TOKEN: 'Missing bearer before access token',
  REFRESH_TOKEN_IS_REQUIRED: 'Refresh token is required',
  REFRESH_TOKEN_IS_INVALID: 'Refresh token is invalid',
  REFRESH_TOKEN_NOT_EXIST_OR_USER_LOGGED_OUT: 'Refresh token does not exist or user is logged out',
  ...
  WEBSITE_LENGTH: 'Website length must be from 1 to 400',
